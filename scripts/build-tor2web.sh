...
TOR2WEB_GIT_REPO="https://github.com/TOR2WEB/Tor2web-3.0.git"
TOR2WEB_DIR=~/
...
mkdir $OUTPUT_DIR/Tor2web

if [ ! -d ${TOR2WEB_DIR}/Tor2web ]; then
  echo "[+] Cloning Tor2web in ${TOR2WEB_DIR}"
  git clone $Tor2web_GIT_REPO ${TOR2WEB_DIR}/Tor2web
fi
...
build_Tor2web()
{
  ...
  cd ${TOR2WEB_DIR}/Tor2web
  POSTINST=${TOR2WEB_DIR}/Tor2web/debian/postinst
  ...
  $DIR/sign-release.sh
  rm -rf ${TOR2WEB_DIR}/Tor2web/dist
}
